...
class RejectSuccessPage extends StatefulWidget {
  final String title;
  ...
  const RejectSuccessPage({
    ...
    this.title = 'Account Rejected',
    this.subtitle = 'The application has been rejected successfully.',
    this.autoCloseDuration = 3,
    this.onClose,
  });

  @override
  State<RejectSuccessPage> createState() => _SuccessPageState();
}

class _SuccessPageState extends State<RejectSuccessPage>
