...
class RemoveSuccessPage extends StatefulWidget {
  final String title;
  final String subtitle;
  final int autoCloseDuration; // in seconds
  final VoidCallback? onClose;

  const RemoveSuccessPage({
    super.key, // Fixed: use_super_parameters
    this.title = 'Account Removed',
    this.subtitle = 'The driver account has been successfully removed.',
    this.autoCloseDuration = 3,
    this.onClose,
  });

  @override
  State<RemoveSuccessPage> createState() => _SuccessPageState();
}

class _SuccessPageState extends State<RemoveSuccessPage>
